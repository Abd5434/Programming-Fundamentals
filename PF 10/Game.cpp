...
bool playerCollisionWithInfantry();
...
void gameInterface()
{
    ...
    while (gameRunning == true)
    {
        if (towerHealth > 0 && balaHealth > 0)
        {
            ...
            printRamboHealth();
            bool collision;
            collision = playerCollisionWithInfantry();
            if(collision == true)
            {
                gameOver();
                gameRunning = false;
...
bool playerCollisionWithInfantry()
{
    ...
    if((ramboX == infantryX + 10) && (ramboY == infantryY) || (ramboX == infantryX + 10) && (ramboY + 1 == infantryY) || (ramboX == infantryX + 10) && (ramboY + 2 == infantryY) || (ramboX == infantryX + 10) && (ramboY + 3 == infantryY) )
    {
        collision = true;
    }
    for(int idx = 0; idx  < 4; idx++)
    {
        if((ramboX == infantryX + 10) && (ramboY + idx == infantryY))
        {
            collision = true;
        }
    }
